...
import numpy as np
import cv2
from protos.tensorflow_protos.core.framework import tensor_pb2  
from protos.tensorflow_protos.core.framework import tensor_shape_pb2, tensor_shape_pb2_grpc 
from protos.tensorflow_protos.core.framework import types_pb2, types_pb2_grpc
